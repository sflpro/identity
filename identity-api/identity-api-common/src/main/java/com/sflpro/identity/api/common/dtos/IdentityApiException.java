 ...
 */
public class IdentityApiException extends WebApplicationException {
    ...
    public IdentityApiException(int responseStatusCode, String message, long applicationErrorCode) {
        this.error = null;
    ...
    public IdentityApiException(IdentityApiError error, Exception cause) {
        this(error, error.getDefaultMessage(), cause);
    }

    public IdentityApiException(IdentityApiError error, String message, Exception cause) {
        this(error, message, error.getResponseHttpStatus().getStatusCode(), cause);
    }

    public IdentityApiException(IdentityApiError error,
                                String message,
    ...
    public IdentityApiException(IdentityApiError error, String message, int responseStatusCode, Exception cause) {
